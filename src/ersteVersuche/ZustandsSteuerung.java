...
public class ZustandsSteuerung {
	...
	public static EV3UltrasonicSensor ultraschallSensorVorne =
	...
	public static SampleProvider seitenAbstandNachRechts =
			ultraschallSensorVorne.getDistanceMode();
	...
	public static void main(String[] args) {
		...
		while (Button.ESCAPE.isUp()) {
			...
			float[] touchSensorObenMesswerte = new float[einparkVorgangAuslöser.sampleSize()];
